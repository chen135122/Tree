...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ config('app.site_ico') }}" />
...
<div class="login-wrapper ">
    ...
    <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            ...
            <p class="p-t-35">重置密码</p>
            <!-- START Login Form -->
            <form id="form-login" class="p-t-15" role="form" action="/admin/resetPassword" method="post">
                <!-- START Form Control-->
                {{ csrf_field() }}
                <input type="hidden" name="token" placeholder="" value="{{ $token }}" class="form-control" required>
                <input type="hidden" name="email" placeholder="" value="{{ $email }}" class="form-control" required>
                ...
                <!-- END Form Control-->
                <button class="btn btn-primary btn-cons m-t-10" type="submit">确认重置</button>
            </form>
            @if (count($errors) > 0)
